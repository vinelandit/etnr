;(function(undefined) {
  ...
  var average = function (array,num) {
    var sum = 0;
      ...
      var success = function (position) {
        ...
        if ( coords.speed > 1 ) {
          ...
          if ( headings.length >= 5 && alphas.length >= 5 ) {
            ...
            self._gpsDiff = average(headings,10) + average(alphas,10);
  ...
  console.log(window.Compass);
    ...
    document.getElementById('start').addEventListener('click',function(){
      ...
      Compass.watch(function(heading) {
        document.getElementById('bearing').innerHTML = heading;
      });
      ...
      Compass.needGPS(function () {
        document.getElementById('bearing').innerHTML = 'Please be outside';          // Step 1: we need GPS signal
      }).needMove(function () {
        document.getElementById('bearing').innerHTML = 'Please hold your phone directly in front of you and walk a few steps'; // Step 2: user must go forward
      }).init(function () {
